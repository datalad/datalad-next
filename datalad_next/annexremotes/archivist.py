...
class ArchivistRemote(SpecialRemote):
    ...
    def _get_fsspec_url_(self, akey, amember_path):
        ...
        if apath:
            ...
            # but actually, no:
            # https://github.com/fsspec/filesystem_spec/issues/1168
            # shows that fsspec does not appreciate the file:// URLs
            # generated by pathlib. It also shows that we can put in
            # a naked path.
            yield f'{atype}://{amember_path}{cache_spec}::{apath}'
